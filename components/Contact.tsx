    ...
    >
      <div className="w-full max-w-[1800px] mx-auto px-6 md:px-12 pt-12 pb-24 relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 mb-24 relative z-20">
          ...
          <div>
            <h1 className="font-display text-5xl md:text-8xl font-bold text-zinc-900 dark:text-white mb-12">
              {t("contact_title")}
            </h1>
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="grid grid-cols-1 gap-6 mb-16">
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <p className="text-sm font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-wide mb-1">
                    {t("contact_email_me")}
                  </p>
                  <p className="text-lg md:text-2xl font-semibold text-zinc-900 dark:text-white break-all">
                    {profile.email}
                  </p>
                </div>
              </a>
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-lg md:text-2xl font-semibold text-zinc-900 dark:text-white">
                    {profile.phone}
                  </p>
                </div>
              </a>
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-[2.5rem] p-8 md:p-10 border border-zinc-200 dark:border-zinc-800 shadow-xl">
              <h3 className="text-3xl font-bold mb-8 text-zinc-900 dark:text-white">
                {t("contact_form_title")}
              </h3>
              <form className="flex flex-col gap-6 text-left">
                <div>
                  <label className="block text-base font-medium text-zinc-500 dark:text-zinc-400 mb-2">
                    {t("contact_form_name")}
                  </label>
                  <input
                    type="text"
                    className="w-full bg-zinc-50 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-2xl px-6 py-4 text-zinc-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-brand-500 transition-all placeholder:text-zinc-400 dark:placeholder:text-zinc-500 text-lg"
                    placeholder=""
                  />
                </div>
                <div>
                ...
                <button
                  type="button"
                  className="bg-zinc-900 dark:bg-brand-600 text-white font-bold py-5 rounded-2xl mt-4 hover:bg-zinc-800 dark:hover:bg-brand-500 transition-colors flex justify-center items-center gap-2 shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:ring-offset-2 text-lg"
                >
