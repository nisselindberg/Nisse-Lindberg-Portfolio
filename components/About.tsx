      ...
      <div className="w-full max-w-[1800px] mx-auto px-6 md:px-12 pt-12 pb-24 relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center mb-32 relative z-20">
          <div className="order-2 lg:order-1">
            <h1 className="font-display text-5xl md:text-8xl font-bold text-zinc-900 dark:text-white mb-10">
              {t("about_title")}
            </h1>
            ...
            <div className="flex flex-wrap gap-3 mt-8">
              {profile.skills.map((skill) => (
                <span
                  key={skill}
                  className="bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 px-6 py-3 rounded-xl font-medium text-zinc-700 dark:text-zinc-300 text-base md:text-lg"
                >
                  {skill}
                </span>
              ))}
