    ...
    <div className="w-full">
      ...
      <section className="min-h-[75vh] flex flex-col justify-center px-6 md:px-12 w-full max-w-[1800px] mx-auto pt-16 md:pt-24 relative">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl lg:text-9xl font-bold text-zinc-900 dark:text-white leading-[1.1] tracking-tight mb-8">
            {t('hero_title')} <br />
          ...
          <p className="text-xl md:text-3xl text-zinc-600 dark:text-zinc-400 max-w-3xl leading-relaxed mb-10 font-normal tracking-wide">
            {t('hero_greeting')} <span className="text-zinc-900 dark:text-white font-semibold">{profile.name}</span>
      ...
      <section id="work" className="py-32 px-6 md:px-12">
        <div className="w-full max-w-[1800px] mx-auto">
          <div className="flex items-end justify-between mb-16">
            <div>
              <h2 className="text-4xl md:text-6xl font-bold text-zinc-900 dark:text-white mb-4 tracking-tight">{t('home_selected_work')}</h2>
