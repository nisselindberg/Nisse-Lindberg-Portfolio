  ...
  return (
    <div className="w-full bg-transparent">
      ...
      <section className="min-h-[100vh] flex flex-col items-center justify-center relative px-6 overflow-hidden pt-24 pb-12">
        ...
        >
          <h1 className="text-4xl md:text-7xl font-black tracking-tighter leading-[1.3] mb-8 font-outfit text-white">
            <span className="block opacity-90">{t('hero_title')}</span>
            <span className="block bg-clip-text text-transparent bg-gradient-to-r from-white via-brand-400 to-emerald-400 drop-shadow-[0_0_20px_rgba(34,211,238,0.15)] py-4 overflow-visible">
              {t('hero_subtitle')}
            </span>
          </h1>
